...
import CortexLogo from "@/assets/Logo.svg"
                ...
                <div className="p-8 bg-surface-custom border border-[var(--semantic-error)] fluid-rounded-xl frosted-glass text-center space-y-6 soft-shadow-lg w-full max-w-md">
                    ...
                    <div className="flex flex-col gap-3 mt-4">
                        <Button 
                            ...
                            className="w-full h-12 uppercase tracking-widest font-mono text-[10px] sm:text-xs gradient-button text-white"
                        >
                            RE-REQUEST ACCESS
                        </Button>
                        <Button 
                            ...
                            className="w-full h-12 uppercase tracking-widest font-mono text-[10px] sm:text-xs bg-surface-custom/50 border border-subtle-custom text-primary-custom"
                        >
                            RETURN TO LOGIN
                        </Button>
                    </div>
